...
🔜 Сейчас: Шаг 7 разбит на 7a (✅ напоминалка) / 7b (инфра MTProto+GramJS, генератор сессии) /
   7c (еженедельный отчёт по просмотрам + модель PostMetric). Дальше — 7b или AI-самообновление
