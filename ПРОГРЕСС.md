...
🔜 Сейчас: Шаг 6b (кнопки на постах: button_prediction/button_choice) — следующая сессия.
   Затем 6c (календарные посты — переосмысленные «праздники», опционально/решить)
📌 Решения:
