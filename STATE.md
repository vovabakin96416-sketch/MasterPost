...
## 🔜 Сейчас
Шаг 6c готов — разовый пост в расписание (мастер «➕ Новый пост»: дата-время, полный
интерактив, фото Pexels/загрузка; публикация одним тиком планировщика по `publishAt`,
минуя одобрение). Дальше:
