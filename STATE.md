...
## 🔜 Сейчас
Шаг 8c готов (комменты маршрутизируются по своему каналу). Дальше:
- **Шаг 10** — AI-самообновление постов (главный приоритет продукта)

Отложено: мультиканальная аналитика (еженедельный отчёт), Шаг 6c (календарные посты).
...
Тесты на момент 8c: **vitest 147/147**, tsc 0, eslint 0.
